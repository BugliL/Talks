...
- Per quanto venga modificato il codice, sappiamo che e' sempre possibile 
  tornare indietro e verificare il test
<!-- .element: class="fragment" -->
...
```
TODO: finire l'esempio
TODO: introduzione delle fixture e facotry boy
TODO: Best practices per ATDD
Usare DSL (Domain-Specific Languages) o strutture narrative come Given-When-Then.
Refactoring continuo:
Migliorare il codice sia dei test che della base di codice principale.
Allineare continuamente i test con i cambiamenti nei requisiti.
...
- Abbiamo visto come stakeholder e sviluppatori possono usare ATDD per collaborare
