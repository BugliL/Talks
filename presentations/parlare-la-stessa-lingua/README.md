...
Bob decide di provare altri approcci

---

## Tentativo 1: User Stories

```text
Come utente
Voglio vedere i documenti colorati
...
"Ma... `quali` colori? `Quando`?"

- Troppo `generica`
<!-- .element: class="fragment" -->

- Mancano i `dettagli` di implementazione
<!-- .element: class="fragment" -->
...
## Tentativo 2: Acceptance Criteria

```text
✓ I documenti devono avere colori
✓ I colori devono essere appropriati
✓ Il sistema deve essere consistente
```
<!-- .element: class="fs-10" -->
...
"Cosa significa `appropriati`?"

- Ancora troppo `vago`
<!-- .element: class="fragment" -->

- `Interpretabile` in modi diversi
<!-- .element: class="fragment" -->
...
"Nessuno di questi funziona davvero!"
